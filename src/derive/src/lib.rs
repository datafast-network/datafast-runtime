...
// }
//
//Note: this macro makes heavy reliance on types to be available via crate::protobuf (network chain crate root/src/protobuf/prelude)
//please see usage exmple in chain::cosmos crate... prelude imports generates protobuf bindings, as well as any other needed types
